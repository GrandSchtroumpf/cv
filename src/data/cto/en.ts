...
export const data: Resume = {
  profile: {
    ...
    keywords: ['CTO', 'Cloud', 'IA', 'CI/CD', 'Performance', 'Scalability', 'Dev Mentoring'],
    summary: `
      <b>I build products for users so the business can grow.</b><br/>
      For the past 10 years I've specialized in building <strong>pragmatic app architectures</strong> dedicated to a business vision.
      ...
      I hired and mentored 11 engineers across multiple countries, shaping the standards for <strong>high quality and maintainable products</strong> centered around the user experience.<br/>
