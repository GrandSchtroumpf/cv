...
export const data: Resume = {
  profile: {
    ...
    summary: `
      For the past <strong>10 years</strong> I've specialized in building advanced frontend architecture and <strong>robust design systems</strong>.
      ...
      Together with backend team we handled <strong>large dataset</strong>, that I displayed to the user through interactive charts to improve <strong>user experience</strong>.
      Security, performance and accessibility is always on top of my mind.`,
  },
  navigation: [
